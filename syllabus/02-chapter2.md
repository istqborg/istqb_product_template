...
2. Another Subchapter name
    ...
    2. (K3) Second Learning Objective for Subchapter x.2, so it is x.2.2
    3. (K3) Third Learning Objective for Subchapter x.2, so it is x.2.3
